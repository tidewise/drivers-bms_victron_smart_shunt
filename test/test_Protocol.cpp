...
TEST_F(ProtocolTest, it_parses_the_feedback)
{
    ...
    ASSERT_NEAR(feedback.deepest_discharge_depth, 12, 1e-3);
    ...
    ASSERT_NEAR(feedback.minimum_voltage, 11, 1e-3);
    ASSERT_NEAR(feedback.maximum_voltage, 16, 1e-3);
    ...
    ASSERT_EQ(feedback.charged_energy, 3000);
